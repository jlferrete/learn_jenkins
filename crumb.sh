...
curl -s -XPOST 'http://jenkins.local:8080/job/backup-db-to-aws/buildWithParameters?DB_HOST=db_host&DB_NAME=testdb&BUCKET_NAME=jlferrete-jenkins-udemy2' -u jenkins:1ffb8250a970e2c6b4feaaef1089b73c -H "$CRUMB" -H "Content-Type:text/xml"
